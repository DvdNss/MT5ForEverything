...
databuilder_args = dict(
   ...
   tokenizer_save_path='model/xsum/tokenizer',  # Tokenizer save path
   train_csv_path='data/xsum/train.csv',  # Training file path
   valid_csv_path='data/xsum/validation.csv',  # Validation file path
   source_column='source_text',  # Source column
   target_column='target_text',  # Target column
   train_data_save_path='data/xsum/train.pt',  # Training data save path
   valid_data_save_path='data/xsum/valid.pt',  # Validation data save path
   databuilder_config_save_path='model/xsum/config/config.json'  # Save path of databuilder config
)
