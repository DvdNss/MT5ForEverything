...
databuilder_args = dict(
   ...
   target_max_length=512,  # Maximum length of target text
   tokenizer_name_or_path='google/mt5-base',  # Tokenizer path
   tokenizer_save_path='model/squad/tokenizer',  # Tokenizer save path
   train_csv_path='data/squad/train.csv',  # Training file path
   valid_csv_path='data/squad/validation.csv',  # Validation file path
   source_column='source_text',  # Source column
   target_column='target_text',  # Target column
   train_data_save_path='data/squad/train.pt',  # Training data save path
   valid_data_save_path='data/squad/valid.pt',  # Validation data save path
   databuilder_config_save_path='model/squad/config/config.json'  # Save path of databuilder config
)
